...
public class BitvavoMarketBookResponse {
    ...
    private BitvavoMarketBookResponse() {
    }

    private BitvavoMarketBookResponse(Builder builder) {
    ...
    public static final class Builder {
        ...
        public BitvavoMarketBookResponse build() {
            return new BitvavoMarketBookResponse(this);
        }
    }
}

...
public class BitvavoCancelOrderRequest {

    private final BitvavoMarket market;
    private final String orderId;

    private BitvavoCancelOrderRequest(Builder builder) {
    ...
    public static final class Builder {
        ...
        public BitvavoCancelOrderRequest build() {
            return new BitvavoCancelOrderRequest(this);
        }
    }
}

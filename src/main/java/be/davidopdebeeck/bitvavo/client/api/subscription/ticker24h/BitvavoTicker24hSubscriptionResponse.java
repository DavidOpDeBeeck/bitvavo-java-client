package be.davidopdebeeck.bitvavo.client.api.subscription.ticker24h;
...
public class BitvavoTicker24hSubscriptionResponse {
    ...
    private BitvavoTicker24hSubscriptionResponse() {
    }

    private BitvavoTicker24hSubscriptionResponse(Builder builder) {
    ...
    public static final class Builder {
        ...
        public BitvavoTicker24hSubscriptionResponse build() {
            return new BitvavoTicker24hSubscriptionResponse(this);
        }
    }
}
